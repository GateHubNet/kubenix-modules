...
in {
  config.kubernetes.moduleDefinitions.bitcoin-cash-node.module = {name, config, ...}: let
    bitcoincashConfig = ''
      ##
  ...
  in {
    ...
    config = {
          ...
          template = {
            ...
            spec = {
              ...
              initContainers = [{
                ...
                image = "busybox";
                command = ["sh" "-c" "cp /config/bitcoin.conf /data/bitcoin.conf"];
                volumeMounts = [{
                  name = "config";
                  mountPath = "/config";
                } {
      ...
      kubernetes.resources.configMaps.bitcoincashd = {
        ...
        data."bitcoin.conf" = bitcoincashConfig;
      };
