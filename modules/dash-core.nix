...
in {
  config.kubernetes.moduleDefinitions.dash-core.module = {config, module, ...}: let
    name = module.name;
    ...
    options = {
      ...
      storage = {
        ...
        size = mkOption {
          ...
          type = types.str;
          default = if config.testnet || config.regtest then "100Gi" else "200Gi";
        };
      };
